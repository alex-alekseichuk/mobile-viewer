...
(function($) {
  ...
  $.cleditor.buttons.table = {
    ...
    popupContent:
      ...
      "<td style=\"padding-right:6px;\">Cols:<br /><input type=text value=4 size=12 style=\"width:70px;\" /></td>" +
      "<td style=\"padding-right:6px;\">Rows:<br /><input type=text value=4 size=12 style=\"width:70px;\" /></td>" +
      "</tr><tr>" +
      "<td style=\"padding-right:6px;\">Cell Spacing:<br /><input type=text value=2 size=12 style=\"width:70px;\" /></td>" +
      "<td style=\"padding-right:6px;\">Cell Padding:<br /><input type=text value=2 size=12 style=\"width:70px;\" /></td>" +
      "</tr><tr>" +
      "<td style=\"padding-right:6px;\">Border:<br /><input type=text value=1 size=12 style=\"width:70px;\" /></td>" +
      "<td style=\"padding-right:6px;\">Style (CSS):<br /><input type=text size=12 style=\"width:70px;\" /></td>" +
